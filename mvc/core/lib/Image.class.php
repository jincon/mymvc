...
class Image {
    ...
    public function __construct() {
        ...
        $this->_fontSize = 14;
        $this->_fontName = ROOT . '/static/font/aispec.ttf';
    ...
    protected function _handleWatermarkFontPlace($limitOption = false) {
        ...
        if (!$this->_fontX || !$this->_fontY) {
            if (!$this->_textContent) {
                Core::halt('You do not set the watermark text on image!');
            }
    ...
    protected function _handleImageSize() {
        ...
        if (!$this->_width || !$this->_height) {
            Core::halt('You do not set the image height size or width size!');
        }
