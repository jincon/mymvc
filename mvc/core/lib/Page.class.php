...
class Page {
    ...
    public function output() {
        ...
        //获取HTML内容
        $html = '<div class="pagelist_box"><ul>';
    ...
    public function select() {
        ...
        $string = '<select name="select_pagelist" class="pagelist_select_box" onchange="self.location.href=this.options[this.selectedIndex].value">';
    ...
    public function loadCss($styleName = 'classic') {
        ...
        $cssFile = __STATIC__. 'css/' . $this->_styleFile;
    ...
    public static function loadCssFile($styleName = 'classic') {
        ...
        switch ($styleName) {
            case 'classic':
                $_styleFile = 'pagelist_classic.min.css';
                break;

            default:
                $_styleFile = 'pagelist_default.min.css';
        }

        $cssFile = __STATIC__ . 'css/' . $_styleFile;
    ...
    public function setMode($styleName = 'classic') {
        ...
        switch ($styleName) {
            ...
            case 'classic':
                $this->_styleFile = 'pagelist_classic.min.css';
                break;

            default:
                $this->_styleFile = 'pagelist_default.min.css';
